<div class="col-xl-6 col-md-6 mx-auto p-5">
    <form nome="login" method="POST">
        ...
        <h1 class="h3 mb-3 fw-normal">Cadastrar Post</h1>

        <div class="form-floating">
        <input value="<?=$dados['titulo']?>" name="titulo" type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
        ...
        <button class="btn btn-primary w-100 py-2 mt-4" value="cadastrar" type="submit">Cadastrar</button>
